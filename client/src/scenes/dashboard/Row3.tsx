...
const Row3 = () => {
  ...
  const pieColors = [palette.primary[800], palette.grey[700]];
  const { data: productsData } = useGetProductsQuery();
  const { data: transactionsData } = useGetTransactonsQuery();
  ...
  const productsColumns = [
    ...
    },
    {
      ...
      headerName: "Expense",
      flex: 0.5,
      renderCell: (params: GridCellParams) => `ksh${params.value}`,
    },
    {
      field: "price",
      headerName: "Price",
  ...
  const transactionsColumns = [
    ...
    {
      field: "productIds",
      headerName: "Count", //how many they bought
      flex: 0.1,
    ...
    <>
      ...
      <DashboardBox gridArea="j">
        ...
        <Typography margin="0 1rem" variant="h6">
          This is the overall summary and data showcasing the organization's
          achievements %
        </Typography>
      </DashboardBox>
    </>
